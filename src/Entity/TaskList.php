...
class TaskList
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="taskLists")
     */
    private $user;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Preferene", mappedBy="list", cascade={"PERSIST", "REMOVE"})
     */
    private $preferences;
    ...
    public function getPreferences(): ?Preferene
    {
        return $this->preferences;
    }

    public function setPreferences(?Preferene $preferences): self
    {
